...
public class AdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        database = FirebaseDatabase.getInstance("https://smdf1-d99c2-default-rtdb.firebaseio.com/");
    ...
    {
        Intent intent = new Intent(AdminActivity.this, BusesDetailsActivity.class);
